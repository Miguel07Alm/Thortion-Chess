...
class Piece:
    def __init__(self, name, coord, r0, img, colour, pieces_choice = None):
        ...
        self.color = white if colour == "white" else black
        self.c = list(map(lambda c: c - 20, self.color))
        ...
        if self.name == "pawn": 
            ...
            self.choice_pieces = [swap_color(swap_color(pieces_choice["queen"],self.c, contour), self.color, color),swap_color(swap_color(pieces_choice["rook"],self.c, contour), self.color, color),swap_color(swap_color(pieces_choice["bishop"],self.c, contour), self.color, color), swap_color(swap_color(pieces_choice["knight"],self.c, contour), self.color, color)]
        ...
        if self.name == "knight" and self.team == "black": self.img = pygame.transform.flip(self.img, False, True)
        if self.name == "queen" and self.team == "black": self.img = pygame.transform.flip(self.img, True, False)
        if self.name == "king" and self.team == "black": self.img = pygame.transform.flip(self.img, True, False)
        ...
        self.img = swap_color(self.img,self.c, contour)
        self.img = swap_color(self.img, self.color, color)
        ...
        if name == "king": 
            ...
            self.n_movements = 0
            self.img = swap_color(self.img, self.c, king_color)
    def contour_selected(self):
        if self.name != "king": self.img = swap_color(self.img, hex_to_rgb("#ff2ee0"),self.c)
        else: self.img = swap_color(self.img, realKingColor,self.c)
    ...
    def reverse_contour(self):
        if self.name != "king": self.img = swap_color(self.img, self.c, hex_to_rgb("#ff2ee0"))
